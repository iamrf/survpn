...
import { Star, Zap, MessageSquare, Headphones } from "lucide-react";
        ...
        <div className="px-5 pt-6">
          ...
          >
            <Button
              ...
              className="rounded-full h-12 w-12 bg-gradient-to-br from-primary/30 to-primary/20 border-2 border-primary/30 hover:from-primary/40 hover:to-primary/30 shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all duration-300"
            >
              <Headphones className="w-7 h-7 text-gray-50" />
            </Button>
          </motion.div>
        </div>
