...
export const translations: Record<LanguageCode, Translations> = {
  fa: {
    ...
    subscription: {
      ...
      professionalSubscription: 'اشتراک حرفه‌ای',
      usageRate: 'نرخ استفاده',
      remainingData: 'حجم باقیمانده',
      totalData: 'حجم کل',
      expiredTime: 'زمان انقضا',
      remainingTime: 'زمان باقیمانده',
      expiresToday: 'امروز منقضی می‌شود',
      expiredDaysAgo: 'روز پیش منقضی شد',
      status: 'وضعیت',
      usageChart: 'نمودار استفاده',
      expiredNotice: 'این اشتراک منقضی شده است. برای استفاده مجدد، لطفاً یک اشتراک جدید خریداری کنید.',
      scanQRCode: 'اسکن کد QR',
      qrCodeDescription: 'این کد را در اپلیکیشن v2ray (مانند v2rayNG یا Shadowrocket) اسکن کنید تا تنظیمات به صورت خودکار اعمال شود.',
      copySubscriptionLink: 'کپی لینک اشتراک',
      username: 'نام کاربری',
      trafficDistribution: 'توزیع ترافیک',
      ofTotalVolume: 'از حجم کل',
      days: 'روز',
      hours: 'ساعت',
      unknown: 'نامشخص',
      totalVolume: 'حجم کل',
      ...
      totalTime: 'زمان کل',
      remainingTimeLabel: 'زمان باقیمانده',
    },
    admin: {
      title: 'مدیریت',
      overview: 'نمای کلی',
  ...
  ar: {
    ...
    subscription: {
      ...
      professionalSubscription: 'اشتراك احترافي',
      usageRate: 'معدل الاستخدام',
      remainingData: 'البيانات المتبقية',
      totalData: 'إجمالي البيانات',
      expiredTime: 'وقت انتهاء الصلاحية',
      remainingTime: 'الوقت المتبقي',
      expiresToday: 'ينتهي اليوم',
      expiredDaysAgo: 'انتهى منذ {days} أيام',
      status: 'الحالة',
      usageChart: 'مخطط الاستخدام',
      expiredNotice: 'انتهت صلاحية هذا الاشتراك. للاستخدام مرة أخرى، يرجى شراء اشتراك جديد.',
      scanQRCode: 'مسح رمز QR',
      qrCodeDescription: 'امسح هذا الرمز في تطبيق v2ray (مثل v2rayNG أو Shadowrocket) لتطبيق الإعدادات تلقائياً.',
      copySubscriptionLink: 'نسخ رابط الاشتراك',
      username: 'اسم المستخدم',
      trafficDistribution: 'توزيع الحركة',
      ofTotalVolume: 'من إجمالي الحجم',
      days: 'أيام',
      hours: 'ساعات',
      unknown: 'غير معروف',
      totalVolume: 'إجمالي الحجم',
      remainingVolume: 'الحجم المتبقي',
      totalTime: 'الوقت الإجمالي',
      remainingTimeLabel: 'الوقت المتبقي',
    },
    admin: {
      title: 'الإدارة',
      overview: 'نظرة عامة',
